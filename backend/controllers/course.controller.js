...
export const updateCourse=async(req,res)=>{
    ...
    try{
        ...
        res.status(500).json({
            errors:"Error im course updating"
        })
...
export const deleteCourse=async(req,res)=>{
    ...
    try{
        ...
        if(!course){
        return res.status(404).json({errors:"Cannot delte ,created by other admin"})
        }
...
export const courseDetails=async(req,res)=>{
    ...
    try{
        ...
        console.log("Error in course detals",error);
    }
}
...
export const buyCourses=async(req,res)=>{
    ...
    try{
        ...
        res.status(201).json({message:"Course purchases successfully",newPurchase}); 
    } 
    catch(error){
