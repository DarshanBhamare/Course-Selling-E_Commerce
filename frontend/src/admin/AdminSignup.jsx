      ...
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] m-8 md:m-0 mt-20">
          <h2 className="text-2xl font-bold mb-4 text-center">
           Admin Welcome to <span className="text-pink-500">CourseTutorials</span>
          </h2>
          <p className="text-center text-gray-400 mb-6">
            Just Signup To Create and Updates Course!
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-pink-500 hover:bg-blue-600 text-white py-3 px-6 rounded-md transition"
            >
              Signup
            </button>
          </form>
